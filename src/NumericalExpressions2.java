...
public class NumericalExpressions2 {
	...
	public static void main(String[] args) {
		...
		// 15 / 4: because both are integers, we will get a quotient 
		System.out.println("15 / 4 gives the quotient = " + (15 / 4)); // 3
		// 15 % 4: remainder 
		System.out.println("15 % 4 gives the remainder = " + (15 % 4)); // 3
		
		// 23 / 4: because both are integers, we will get a quotient
		System.out.println("23 / 4 gives the quotient = " + (23 / 4)); // 5
		// 23 % 4: remainder 
		System.out.println("23 % 4 gives the remainder = " + (23 % 4)); // 3
		
		// 4 * (23 / 4) + (23 % 4) = 23
		System.out.println("divisor * qutient + remainder = original number = " + (4 * (23 /4) + (23 % 4)));
		
		// System.out.println("1" * "1"); // this output is not correct 
		System.out.println("output 1 + 1 ver batim = " + "1 + 1"); // output: 1 + 1
		System.out.println("output of the result of calculating 1 + 1 = " + (1 + 1)); // output: 2
